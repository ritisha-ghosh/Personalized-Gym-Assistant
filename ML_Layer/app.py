...
def initialize_ml_engine():
    """Instantly loads the pickled ML model to prevent first-hit latency."""
    global vectorizer, model
    try:
        # Load the pre-trained brain generated by train_model.py
        vectorizer = joblib.load('vectorizer.pkl')
        model = joblib.load('model.pkl')
        print("✅ ML Engine loaded from Pickle files successfully.")
