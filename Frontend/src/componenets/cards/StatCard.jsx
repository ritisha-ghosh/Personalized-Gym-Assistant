...
const StatCard = ({ title, value, unit, footer, accent }) => {
  ...
  return (
    <div className={`rounded-2xl p-6 shadow-sm border flex flex-col justify-between backdrop-blur-md ${isDarkMode ? 'bg-[#1e293b]/60 border-[#334155]/60' : 'bg-white/60 border-slate-100/60'}`}>
